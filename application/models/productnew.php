...
class Productnew extends CI_model{
...
if($productCount>0)
{
	...
	{
	$productnewlist="Şu sdfadf an stoklarımızda ürün bulunmamaktadır";	
...
$productnewlist="We have no dsafdfas products listed in our store yet";	
return $productnewlist;
}
