...
s_a[231]="Adana|Adıyaman|Afyon|Ağrı|Aksaray|Amasya|Ankara|Antalya|Ardahan|Artvin|Aydın|Balıkesir|Bartın|Batman|Bayburt|Bilecik|Bingöl|Bitlis|Bolu|Burdur|Bursa|Çanakkale|Çankırı|Çorum|Denizli|Diyarbakır|Düzce|Edirne|Elazığ|Erzincan|Erzurum|Eskişehir|Gaziantep|Giresun|Gümüşhane|Hakkari|Hatay|İçel|Iğdır|Isparta|İstanbul|İzmir|Kahramanmaraş|Karabük|Karaman|Kars|Kastamonu|Kayseri|Kilis|Kırıkkale|Kırklareli|Kırşehir|Kocaeli|Konya|Kütahya|Malatya|Manisa|Mardin|Muğla|Muş|Nevşehir|Niğde|Ordu|Osmaniye|Rize|Sakarya|Samsun|Şanlıurfa|Siirt|Sinop|Şırnak|Sivas|Tekirdağ|Tokat|Trabzon|Tunceli|Uşak|Van|Yalova|Yozgat|Zonguldak";
...
function populateCountries(countryElementId, stateElementId){
	...
	countryElement.options[0] = new Option(country_arr[230],'');
	...
	stateElement.options[0] = new Option('Seçiniz',0);
	stateElement.selectedIndex = 250;
	
	var state_arr = s_a[231].split("|");
...
function populateStates( countryElementId, stateElementId ){
	...
	stateElement.length=0;	// Fixed by Julian Woods
	stateElement.options[0] = new Option('Seçiniz','');
	stateElement.selectedIndex = 250;
